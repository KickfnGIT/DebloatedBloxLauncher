...
:: Clean up Documents\roblox (preserve skyboxfix and Customize settings and textures)
...
if exist "!DOC_ROBLOX!" (
    ...
    for /d %%F in ("!DOC_ROBLOX!\*") do (
        set "FOLDER=%%~nxF"
        if /i not "!FOLDER!"=="skyboxfix" if /i not "!FOLDER!"=="Change settings Or revert to default textures" (
